...
import 'foodbank_registration.dart';
...
class RegistrationHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Padding(
          padding: const EdgeInsets.all(24.0), // Space around screen edges
          child: Column(
  ...
  if (value == 'consumer') {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const ConsumerRegistrationPage()),
    );
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const FoodBankRegistrationPage()),
    );
  }
},
